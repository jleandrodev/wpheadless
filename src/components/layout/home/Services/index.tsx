...
export default function Component() {
  return (
    <section id="services-section" className="w-full py-12 md:py-24 lg:py-32">
      <div className="flex flex-col container px-4 md:px-6 text-center justify-center items-center">
        ...
        <div className="container grid max-w-8xl gap-8 lg:grid-cols-3 xl:max-w-8xl xl:gap-10">
          <div className="grid gap-6">
            <ServiceCard
              ...
              description="Get your app up and running in no time with our streamlined deployment process."
              icon={RocketIcon}
            />
            <ServiceCard
              title="Customizable"
